...
def go(config: DictConfig):
    ...
    if "download" in steps_to_execute:
        ...
        _ = mlflow.run(
            os.path.join(root_path, "download"), # the pah to the steo inside de repo
            "main",
            parameters={
    ...
    if "preprocess" in steps_to_execute:
        ...
        _ = mlflow.run(
            ...
            parameters={
                ...
                "artifact_description": "Data with preprocess"
            },
        )
    ...
    if "evaluate" in steps_to_execute:
        ...
        _ = mlflow.run(
            ...
            "main",
            parameters={
                "model_export":  f"{random_forest_pipeline["random_forest_pipeline"]["export_artifact"]}",
